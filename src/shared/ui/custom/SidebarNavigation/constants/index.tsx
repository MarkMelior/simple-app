...
export const SidebarLinks: SidebarLinksProps[] = [
  {
    ...
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24">
        <path
          className="fill-blue-400 transition group-hover:fill-blue-500 dark:fill-slate-600 dark:group-hover:fill-blue-300"
          clipRule="evenodd"
  ...
  },
  {
    ...
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24">
        <path
          className="fill-red-400 transition group-hover:fill-red-500 dark:fill-slate-600 dark:group-hover:fill-red-300"
          clipRule="evenodd"
          d="M19 12a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"
          fillRule="evenodd"
        />
        <path
          className="fill-red-50 group-hover:fill-red-100 dark:fill-slate-400 dark:group-hover:fill-white"
  ...
  },
  {
    ...
    icon: (
      <svg className="size-6" fill="none" viewBox="0 0 24 24">
        <path
          className="fill-blue-400 transition group-hover:fill-blue-500 dark:fill-slate-400 dark:group-hover:fill-blue-300"
          clipRule="evenodd"
    ...
    link: 'https://www.artstation.com/MarkMelior',
    name: 'ArtStation',
  },
];
