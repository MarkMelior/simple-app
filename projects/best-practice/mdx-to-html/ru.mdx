...
Сначала прочитайте статью про [интернационализацию](/projects/best-practice/app-router-i18n)
...
```tsx filename="shared/config/mdx/mdx-components.tsx" githubPath="src/shared/config/mdx/mdx-components.tsx"
...
```tsx filename="shared/config/mdx/mdx-remote.tsx" githubPath="src/shared/config/mdx/mdx-remote.tsx"
